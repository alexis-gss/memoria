...
return [
    ...
    'tracing' => [
        ...
        // Configures if the performance trace should continue after the response has
        // been sent to the user until the application terminates.
        // This is required to capture any spans that are created after the response
        // has been sent like queue jobs dispatched using `dispatch(...)->afterResponse()` for example.
